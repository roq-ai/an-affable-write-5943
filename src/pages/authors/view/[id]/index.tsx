...
import { getAuthorById } from 'apiSdk/authors';
import { AuthorInterface } from 'interfaces/author';

function AuthorViewPage() {
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('author', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/authors/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="author" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
