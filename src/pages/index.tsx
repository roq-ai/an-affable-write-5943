...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`An Affable writer`}</title>

        <meta
          name="description"
          content="Welcome to An Affable Writer - Your Gateway to Discovering Unique Stories. Immerse yourself in a world of captivating narratives, available for purchase at your convenience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1455390582262-044cdead277a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhdXRob3J8ZW58MHx8fHwxNjk2MDUzNDYxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@aaronburden?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Aaron Burden`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to An Affable Writer - Your Gateway to Discovering Unique Stories. Immerse yourself in a world of captivating narratives, available for purchase at your convenience.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Author" type="author" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
